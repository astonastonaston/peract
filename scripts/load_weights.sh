...
# load weights from permanent storage to the runtime directory
cp -r /dev/nanxiao-vol1/arm_test_unified_demos_pickcube_single_view_60_20ksteps/arm_test /tmp/
cp -r /dev/nanxiao-vol1/arm_unified_demos_pickcube_single_view_60_20ksteps/arm /tmp/
