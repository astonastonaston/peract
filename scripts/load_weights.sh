...
# load weights from permanent storage to the runtime directory
cp -r /dev/nanxiao-vol1/arm_test_unified_demos_stackcube_demofixed_60ksteps_delta01/arm_test /tmp/
cp -r /dev/nanxiao-vol1/arm_unified_demos_stackcube_demofixed_60ksteps_delta01/arm /tmp/
