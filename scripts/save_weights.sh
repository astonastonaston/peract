...
# save results to permanent storage
mkdir /dev/nanxiao-vol1/arm_test_unified_demos_longdesc
mkdir /dev/nanxiao-vol1/arm_unified_demos_longdesc
cp -r /tmp/arm_test /dev/nanxiao-vol1/arm_test_unified_demos_longdesc
cp -r /tmp/arm /dev/nanxiao-vol1/arm_unified_demos_longdesc
