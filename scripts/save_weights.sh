...
# save results to permanent storage
mkdir /dev/nanxiao-vol1/arm_test_unified_demos_50_multi_cam
mkdir /dev/nanxiao-vol1/arm_unified_demos_50_multi_cam
cp -r /tmp/arm_test /dev/nanxiao-vol1/arm_test_unified_demos_50_multi_cam
cp -r /tmp/arm /dev/nanxiao-vol1/arm_unified_demos_50_multi_cam
