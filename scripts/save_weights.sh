...
# save results to permanent storage
mkdir /dev/nanxiao-vol1/arm_test_bnd_ts_desc_long
mkdir /dev/nanxiao-vol1/arm_bnd_ts_desc_long
cp -r /tmp/arm_test /dev/nanxiao-vol1/arm_test_bnd_ts_desc_long
cp -r /tmp/arm /dev/nanxiao-vol1/arm_bnd_ts_desc_long
