...
# save results to permanent storage
mkdir /dev/nanxiao-vol1/arm_test_unified_demos_pickcube_single_view_60_60ksteps
mkdir /dev/nanxiao-vol1/arm_unified_demos_pickcube_single_view_60_60ksteps
cp -r /tmp/arm_test /dev/nanxiao-vol1/arm_test_unified_demos_pickcube_single_view_60_60ksteps
cp -r /tmp/arm /dev/nanxiao-vol1/arm_unified_demos_pickcube_single_view_60_60ksteps
