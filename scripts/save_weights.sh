...
# # save results to permanent storage
# mkdir /dev/nanxiao-vol1/arm_test_unified_pushcube_50demos_80ksteps_unified
# mkdir /dev/nanxiao-vol1/arm_unified_pushcube_50demos_80ksteps_unified
...
# save results to permanent storage
mkdir /dev/nanxiao-vol1/arm_test_unified_stackcube_50demos_80ksteps_unified
mkdir /dev/nanxiao-vol1/arm_unified_stackcube_50demos_80ksteps_unified
cp -r /tmp/arm_test /dev/nanxiao-vol1/arm_test_unified_stackcube_50demos_80ksteps_unified
cp -r /tmp/arm /dev/nanxiao-vol1/arm_unified_stackcube_50demos_80ksteps_unified
...
# mkdir /dev/nanxiao-vol1/arm_unified_demos_30_single_cam
# cp -r /tmp/arm_test /dev/nanxiao-vol1/arm_test_unified_demos_30_single_cam
# cp -r /tmp/arm /dev/nanxiao-vol1/arm_unified_demos_30_single_cam
...
# mkdir /dev/nanxiao-vol1/arm_bnd
# cp -r /tmp/arm_test /dev/nanxiao-vol1/arm_test_bnd
# cp -r /tmp/arm /dev/nanxiao-vol1/arm_bnd

# mkdir /dev/nanxiao-vol1/arm_test_kp_red_cam_3_aug5
# mkdir /dev/nanxiao-vol1/arm_kp_red_cam_3_aug5
# cp -r /tmp/arm_test /dev/nanxiao-vol1/arm_test_kp_red_cam_3_aug5
# cp -r /tmp/arm /dev/nanxiao-vol1/arm_kp_red_cam_3_aug5
