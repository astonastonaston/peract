...
python -m mani_skill.utils.download_demo $taskname -o "demos"
...
python -m replay_tools.replay_trajectory --traj-path demos/$taskname/motionplanning/trajectory.h5 --save-traj --obs-mode pointcloud --num-procs 1 --count $demo
