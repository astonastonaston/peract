...
python -m mani_skill.trajectory.replay_trajectory --traj-path demos/PushCube-v1/motionplanning/trajectory.h5 --save-traj --obs-mode pointcloud -b "gpu" --num-procs 1 --count 200