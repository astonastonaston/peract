...
cp -r /dev/nanxiao-vol1/arm_test_pushcube_se3_smaller_mv/arm_test/multi/PERACT_BC/seed0/weights ckpts/multi/PERACT_BC/seed0/
# cp -r /dev/nanxiao-vol1/arm_test_stackcube_se3_smaller_mv/arm_test/multi/PERACT_BC/seed0/weights ckpts/multi/PERACT_BC/seed0/
